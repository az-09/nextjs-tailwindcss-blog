...
export default function NavBar() {
    ...
    return (
        <div className="w-11/12 md:w-full max-w-3xl flex flex-row justify-between">
            <Link href="/">
                <div className="font-bold">tae hee choi</div>
            </Link>
            <ActiveLink href="/" activeClassName="text-blue-500 font-bold">
                <div className="hover:text-blue-500 ">blog</div>
            </ActiveLink>
            <ActiveLink href="/projects" activeClassName="text-blue-500 font-bold">
                <div className="hover:text-blue-500">projects</div>
            </ActiveLink>
            <ActiveLink href="/about" activeClassName="text-blue-500 font-bold">
